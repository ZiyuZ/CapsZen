...
| <kbd>CapsLock</kbd> + <kbd>Y</kbd> | - | Translate to English | Translate selected text to English |
...
- Volume control (scroll wheel + CapsLock)
- Window management (mouse side buttons)
